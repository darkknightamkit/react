    ...
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-green-800 text-orange-500 '>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          <input type="text" value={password} className=' w-full px-4 py-2 text-white font-italic' placeholder='Password' readOnly />
          <button className='outline-none bg-blue-600 text-white px-3 py-0.5 shringk-0'>copy</button>
        </div>
        <div
